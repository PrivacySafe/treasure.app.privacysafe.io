    ...
    ValuesSequence.BinaryValue = (function() {
      ...
      BinaryValue.decode = function decode(reader, length) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.json_ipc.ValuesSequence.BinaryValue();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    ValuesSequence.TransferredObj = (function() {
      ...
      TransferredObj.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.json_ipc.ValuesSequence.TransferredObj();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
    ...
    ValuesSequence.Value = (function() {
      ...
      Value.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
          reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.json_ipc.ValuesSequence.Value();
        while (reader.pos < end) {
          var tag = reader.uint32();
          switch (tag >>> 3) {
            case 1: {
...
function makeReqRepMethodCaller(connection, method, transforms) {
  return (async (...args) => {
    ...
    return replyFromPassedDatum(reply, transforms === null || transforms === void 0 ? void 0 : transforms.unpackReply);
  });
}

function makeObservableMethodCaller(connection, method, transforms) {
  return ((obs, ...args) => {
    const req = argsToPassedDatum(args, transforms === null || transforms === void 0 ? void 0 : transforms.packRequest);
    const obsWrap = {
      next: data => {
...
function makeServiceCaller(connection, reqRepMethods, obsMethods, transforms) {
  const caller = {};
  if (reqRepMethods) {
    for (const method of reqRepMethods) {
      caller[method] = makeReqRepMethodCaller(connection, method, (transforms ? transforms[method] : undefined));
    }
  }
  if (obsMethods) {
    for (const method of obsMethods) {
      caller[method] = makeObservableMethodCaller(connection, method, (transforms ? transforms[method] : undefined));
    }
  }
  return caller;
}

export { makeObservableMethodCaller, makeReqRepMethodCaller, makeServiceCaller };
